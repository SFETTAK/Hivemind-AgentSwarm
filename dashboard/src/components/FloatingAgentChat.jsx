...
// Floating chat window for any agent (spawned by double-clicking in topology)
export default function FloatingAgentChat({ agent, onClose, initialPosition }) {
  ...
  const sendMessage = async () => {
    ...
    try {
      // Send message to the specific agent via tmux
      const res = await fetch(`${apiUrl}/api/agents/${agent.shortName}/send`, {
        method: 'POST',
