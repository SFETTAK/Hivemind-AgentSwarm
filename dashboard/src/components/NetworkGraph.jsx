...
export default function NetworkGraph() {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      agents.forEach(agent => {
        ...
        // Status indicator
        const statusColors = { active: '#00ff88', idle: '#ffcc00', stuck: '#ff4757', offline: '#71717a' }
        ctx.beginPath()
  ...
  const screenToCanvas = useCallback((screenX, screenY) => {
    ...
    // Apply inverse transform (pan then zoom)
  ...
  const findAgentAt = useCallback((x, y) => {
